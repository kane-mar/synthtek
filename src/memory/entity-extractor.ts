...
const ENTITY_PATTERNS: Array<{
	...
	// Organizations (common company names)
	{
		type: "Organization",
		regex:
			/\b(Google|Apple|Microsoft|Amazon|Meta|OpenAI|Anthropic|Tesla|Netflix|IBM|Intel|NVIDIA|Oracle|Salesforce|Adobe|Cisco|Cisco|Uber|Airbnb|Spotify|Twitter|Facebook|Instagram|LinkedIn|Reddit|Discord|Slack|GitHub|GitLab|Docker|Kubernetes)\b/i,
	},
	...
	{ type: "Date", regex: /\b\d{4}-\d{2}-\d{2}\b/ },
	{
		type: "Date",
		regex:
			/\b(today|tomorrow|yesterday|next\s+week|last\s+week|this\s+month)\b/i,
	},
	...
	// Locations (common city/country names)
	{
		type: "Location",
		regex:
			/\b(San Francisco|New York|Los Angeles|Chicago|Seattle|Boston|London|Paris|Berlin|Tokyo|Beijing|Shanghai|Sydney|Toronto|Singapore|Dubai|Moscow|Madrid|Rome|Amsterdam|Stockholm|Oslo|Helsinki|Zurich|Vienna|Prague|Warsaw|Budapest|Athens|Lisbon|Dublin|Edinburgh|Manchester|Liverpool|Birmingham|San Jose|Austin|Denver|Portland|Miami|Atlanta|Dallas|Houston|Phoenix|Philadelphia|Washington)\b/i,
	},
	{
		type: "Location",
		regex:
			/\b(United States|United Kingdom|Canada|Germany|France|Japan|China|India|Australia|Brazil|Russia|Italy|Spain|Netherlands|Sweden|Norway|Finland|Switzerland|Austria|Czech Republic|Poland|Greece|Portugal|Ireland|Mexico|Argentina|South Korea|Singapore|UAE|Saudi Arabia)\b/i,
	},

	// Tasks (TODO, FIXME, HACK patterns)
	{
		type: "Task",
		regex: /\b(TODO|FIXME|HACK|XXX|NOTE):\s*([^\n]+)/gi,
		group: 2,
	},
	...
	// Events (conference, meeting, deadline patterns)
	{
		type: "Event",
		regex:
			/\b(conference|meeting|deadline|launch|release|event|workshop|seminar|webinar|hackathon|summit|forum|symposium)\b/i,
	},
	...
	// Concepts (abstract ideas, technologies)
	{
		type: "Concept",
		regex:
			/\b(AI|machine learning|deep learning|neural network|blockchain|cryptocurrency|cloud computing|microservices|DevOps|CI\/CD|Kubernetes|Docker|TypeScript|JavaScript|Python|Rust|Go|React|Vue|Angular|Node\.js|REST|GraphQL|WebSocket|OAuth|JWT|API|database|serverless|edge computing)\b/i,
	},
];
