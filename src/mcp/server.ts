...
export class MCPServer {
  ...
  async listPrompts(): Promise<
    Array<{ name: string; description: string; arguments: Array<{ name: string; description: string; required?: boolean }> }>
  > {
    const result: Array<{ name: string; description: string; arguments: Array<{ name: string; description: string; required?: boolean }> }> = [];
