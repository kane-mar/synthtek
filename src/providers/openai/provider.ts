...
const REASONING_MODELS = ['o1', 'o1-mini', 'o1-preview', 'o1-preview-2024-09-12', 'o1-2024-12-17', 'o3-mini', 'o3-mini-2025-01-31'];
...
function toOpenAIMessages(messages: ProviderMessage[]): Array<{
  ...
  return messages.map((m) => {
    if (m.contentParts && m.contentParts.length > 0) {
      const parts: Array<{ type: string; text?: string; image_url?: { url: string; detail?: string } }> = m.contentParts.map((part: ContentPart) => {
        if (part.type === 'text') {
