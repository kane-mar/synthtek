...
import { Logger, LogLevel, LOG_LEVELS, LogEntry, LoggingService, LogOutputFormat } from './types.js';
...
class ConsoleLogger implements Logger {
  ...
  constructor(options: { prefix?: string; level?: LogLevel; format?: LogOutputFormat } = {}) {
    ...
    if (plugin) {
      ...
      if (this.fileLogger) {
        const fileLogger = new RotatingFileLogger({
          logDir: join((this.fileLogger as any).logDir ?? '/tmp/logs/synthtek/files'),
          serviceName: service,
