...
export interface TelegramMessage {
  ...
  /** Message type */
  messageType: 'text' | 'photo' | 'document' | 'audio' | 'video' | 'voice' | 'sticker' | 'animation' | 'unknown';
...
export interface TelegramTypingIndicator {
  /** Action type */
  action: 'typing' | 'upload_photo' | 'record_video' | 'upload_video' | 'record_audio' | 'upload_audio' | 'upload_document' | 'choose_sticker';
}
...
export interface TelegramInlineQueryResult {
  /** Result type */
  type: 'article' | 'photo' | 'gif' | 'mpeg4_gif' | 'video' | 'audio' | 'document' | 'location' | 'venue';
  /** Unique result ID */
  id: string;
  /** Title */
  title?: string;
