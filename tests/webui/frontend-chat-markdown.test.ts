...
describe("ChatComponent Markdown Rendering", () => {
	...
	describe("renderMarkdown", () => {
		...
		it("should render inline code", () => {
			...
			assert.ok(
				html.includes("<code>console.log()</code>"),
		...
		it("should render links", () => {
			const html = chat.renderMarkdown(
				"Check [GitHub](https://github.com) for more",
			);
			assert.ok(
				html.includes('<a href="https://github.com">GitHub</a>'),
				"Should render link",
			);
		});
	...
	describe("render with markdown", () => {
		it("should render assistant messages with markdown", () => {
			...
			assert.ok(
				...
				"Should render inline code in assistant messages",
			);
		});
		...
		it("should not render markdown for user messages", () => {
			...
			assert.ok(
				...
				"Should not render bold for user messages",
			);
			assert.ok(
				!html.includes("<code>"),
				"Should not render code for user messages",
			);
		});
	});
});
