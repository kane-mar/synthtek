...
describe('HotReloadManagerImpl', () => {
  test('starts and stops', () => {
    ...
    const configLoader = {
      getConfig: () => ({ name: 'test', version: '1.0.0', workspace: '/tmp', logLevel: 'info', maxExecTimeout: 60, maxExecRetries: 3, spawnTimeout: 300 }),
      reload: () => ({ name: 'test', version: '1.0.0', workspace: '/tmp', logLevel: 'info', maxExecTimeout: 60, maxExecRetries: 3, spawnTimeout: 300 }),
      getConfigPath: () => null,
    };
