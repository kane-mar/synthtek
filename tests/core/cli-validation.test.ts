...
describe('CLI Validation Module', () => {
  ...
  describe('sanitizePath', () => {
    ...
    it('should accept absolute paths within workspace', () => {
      const result = sanitizePath('/tmp/synthtek-workspace/src/index.ts', workspaceRoot);
  ...
  describe('validateConfigKey', () => {
    ...
    it('should reject keys with invalid characters', () => {
      assert.throws(() => validateConfigKey('key with spaces'), ValidationError);
    ...
    it('should reject overly long keys', () => {
      assert.throws(
        () => validateConfigKey('a'.repeat(257)),
        ValidationError,
      );
    });
  });
